<template>
	<div class="flex flex-col flex-grow">
		<ul>
		<li v-for="(robot, index) in robotsList" :key="index" @mouseover="hoverIndex = index" @mouseleave="hoverIndex = -1" class="flex flex-row mb-2 p-3 hover:bg-gray-200 rounded-lg transition-all">
