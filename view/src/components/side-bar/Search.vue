	...
	<div class="flex flex-col h-full p-4 scrollable">
		...
		<div class="flex items-center justify-center pt-4">
			<div class="relative w-full">
				<input ref="searchInput" v-model="searchQuery" @input="onSearch" type="text" placeholder="Search..." class="w-full py-2 px-4 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 transition duration-200"/>
				<svg xmlns="http://www.w3.org/2000/svg" class="absolute right-4 top-1/2 transform -translate-y-1/2 w-5 h-5 text-gray-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
